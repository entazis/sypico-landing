        ...
        <Navbar bg="light" expand="lg">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className={['ml-auto', classes.navText]} activeKey={location.hash}>
              <Nav.Link href="#home"><FormattedMessage {...messages.topBarHome}/></Nav.Link>
              <Nav.Link href="#services"><FormattedMessage {...messages.topBarServices}/></Nav.Link>
              <Nav.Link href="#our-work"><FormattedMessage {...messages.topBarOurWork}/></Nav.Link>
              <Nav.Link href="#team"><FormattedMessage {...messages.topBarTeam}/></Nav.Link>
              <Nav.Link href="#testimonials"><FormattedMessage {...messages.topBarTestimonials}/></Nav.Link>
              <Nav.Link href="#about"><FormattedMessage {...messages.topBarAbout}/></Nav.Link>
              <Nav.Link href="#contact"><FormattedMessage {...messages.topBarContact}/></Nav.Link>
              <Nav.Link href="#careers"><FormattedMessage {...messages.topBarCareers}/></Nav.Link>
            </Nav>
          </Navbar.Collapse>
        </Navbar>
      </div>

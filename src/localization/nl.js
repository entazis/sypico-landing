...
const messages = {
  aboutTitle: 'NL: About Our Business',
  aboutSubtitle: 'NL: Automate, keep going and going!',
  aboutP1: 'NL: Have you ever wondered how much time you waste on watching parameters several times a day to gather them into reports? Do you get any happier whilst processing data from multiple documents and trying your hardest to combine them in a clearly structured overview? Or even worse, how does it make you feel to browse the same web page over and over again?',
  aboutP2: 'NL: These tasks may be very crucial to your business but nevertheless we all know that they are not the most satisfying.',
